...
@app.route('/api/addschedules', methods=['POST'])
def addSchedule():
    try:
        data = request.get_json()
...
@app.route('/api/editschedules/<int:schedule_id>', methods=['PUT'])
...
@app.route('/api/deleteschedules/<int:schedule_id>', methods=['DELETE'])
